...
namespace Cukiernia.Aplication.Cukiernia.Commands.CreateSubProduct
{
    ...
    {
        public CreateSubProductCommandValidator(IBakingRepository bakingRepository)
        {
            RuleFor(n => n.Name)
               ...
               .Custom((value, context) =>
               {
                   if (value != null)
                   {
                       var existingSubProducts = bakingRepository.GetSubProductByName(value).Result;
                       if (existingSubProducts != null)
                       {
